 ...
 *
 * Usage:
 *   npx filesystem-slim                    # Run MCP server
 *   npx filesystem-slim --setup            # Auto-configure (interactive)
 *   npx filesystem-slim --setup claude     # Auto-configure for Claude Desktop
 *   npx filesystem-slim --setup cursor     # Auto-configure for Cursor
 *   npx filesystem-slim --setup claude-code # Auto-configure for Claude Code CLI
 */
...
const MCP_NAME = 'filesystem-slim';
const PACKAGE_NAME = 'filesystem-slim';
